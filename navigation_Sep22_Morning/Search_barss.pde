...
class rNavBars {
 rSearchButton searchButtons[];
  rNavBars () {
    searchButtons = new rSearchButton[0];

    searchButtons = (rSearchButton []) append (searchButtons, new rSearchButton(0, 267, 223, 56, "DAILY"));
    searchButtons = (rSearchButton []) append (searchButtons, new rSearchButton(0, 323, 223, 56, "MONTHLY"));
    searchButtons = (rSearchButton []) append (searchButtons, new rSearchButton(0, 379, 223, 56, "ANNUALLY"));
...
class rSearchButton{
  ...
  String Search;
  boolean pressed = false;
  rSearchButton(float x, float y, float w, float h, String Search) {
    this.x = x;
    this.y = y;
    this.w = w;
    this.h = h;
