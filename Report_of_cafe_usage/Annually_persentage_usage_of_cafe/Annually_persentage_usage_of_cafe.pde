...
try {
  ...
  println ("************************************************************************");
  println ("From", cafe_users, "students", (BF/avg*100)/cafe_users, "%", "of students have eaten Break fast in the last Year.");
  println ("From", cafe_users, "students", (BF/avg*100)/cafe_users, "%", "of students have eaten Lunch in the last Year.");
  println ("From", cafe_users, "students", (BF/avg*100)/cafe_users, "%", "of students have eaten Dinner in the last Year.");
  println ("************************************************************************");
} 
catch (Exception e ) {
  println (e);
