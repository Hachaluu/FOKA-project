...
void setup() {
  ...
  gate2 = new Cards (858, 171, "Gate 2", "Scanning...", "Last Entry: 3sec ago", null, green);
  gate3 = new Cards (402, 448, "Gate 3", "Scanning...", "Last Entry: 5sec ago", null, lightblue);
  gate4 = new Cards (858, 448, "Gate 4", "Scanning...", "Last Entry: 2sec ago", null, yellow);
